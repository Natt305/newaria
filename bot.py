...
_CHAR_IMAGE_EXTRACTION_QUESTION = (
    ...
    "HAT — if a hat is present, list it FIRST as its own entry with color, style, material.\n"
    "For EACH outfit piece, cover ALL FIVE axes:\n"
    "  1. EXACT COLOR (use precise shade names: 'deep crimson', 'charcoal black', 'off-white')\n"
    "  2. GARMENT TYPE (use precise vocabulary above)\n"
    "  3. MATERIAL / TEXTURE ('matte wool', 'shiny satin', 'smooth patent leather', 'soft cotton')\n"
    "  4. SILHOUETTE / FIT ('structured', 'flared', 'slim-fit', 'loose draped', 'form-fitting')\n"
    "  5. DISTINCTIVE DETAILS (buttons, trim, embroidery, ruffles, cutouts, hardware, lace)\n\n"
    ...
    "shorts if visible, stockings/tights, shoes. Each piece gets all 5 axes. "
    "Use format: (1) [description] (2) [description] ... etc.]\n\n"
    ...
    "  ✓ Outfit: does every piece have all five axes? Is a hat listed first if present?\n"

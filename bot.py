...
def build_system_prompt(name: str, background: str, personality: str = "", looks: str = "", kb_context: str = "", memory_context: str = "", visual_kb_context: str = "", character_images_context: str = "") -> str:
    prompt = (
        ...
        "EVERY part of your reply must be in the same language — dialogue, subtext, action narration, all of it. "
        "Never mix languages within a single reply (e.g. Chinese dialogue with English subtext is wrong).\n\n"
    ...
    if _IMAGE_BACKEND == "comfyui":
        ...
        try:
            ...
            if _vram_free_mb is not None and _vram_total_mb is not None:
                print(
                    f"[ComfyUI] VRAM: {_vram_free_mb} MB free "
                    f"/ {_vram_total_mb} MB total"
                )

...
async def enhance_image_prompt(
    ...
    image_note = (
        ...
        "OVERRIDE 3 — ART STYLE: identify whether the reference is 2D illustration, 3D rendered anime, "
        "Live2D, sketch, etc. If it has smooth 3D shading and no ink outlines, write '3D rendered anime character', "
        "NOT '2D art'. Describe what you actually see.\n"
        if has_images else ""
    )
    ...
    system = (
        ...
        "CRITICAL: if the reference image has smooth 3D shading and no visible ink outlines, it is a 3D render — "

...
async def enhance_image_prompt(
    ...
    system = (
        ...
        "  Example (vivid): 'vivid warm amber-yellow eyes, high saturation, medium brightness'\n"
        "  Example (muted): 'very low-saturation muted olive-brown eyes with yellowish-green undertone, soft, medium brightness'\n"
        ...
        "NOT at the neck. Layered ruffles fan downward. Secured with a brooch at the apex. "
        "Sits inside the cape's neckline. "
        "Describe as: 'off-white ruffled jabot; sternum-level, V-shaped, layered ruffles, [color]-gemstone brooch'. "
        "NEVER call it a 'collar' or 'detachable collar' — it is a jabot.\n"
        "  • SHORTS = visible leg garment ending above mid-thigh. "
        "If red fabric with rows of gold/cream buttons is visible at the lower body, it is red shorts, NOT a vest or blouse. "
        "Describe as: 'deep-crimson shorts; double-row [color] buttons, visible below waist'.\n"
        ...
        "Example (vivid): 'vivid warm amber-yellow eyes, high saturation, medium brightness'. "
        "Example (muted): 'very low-saturation muted olive-brown eyes with yellowish-green undertone, soft'. "
    ...
    if has_images:
        ...
        user_content = (
            ...
            "always pair hue with explicit saturation (e.g. 'vivid warm amber-yellow eyes, high saturation, medium brightness').\n"
            ...
            "Describe as: 'deep-crimson shorts; double-row gold buttons, visible below waist'.\n"

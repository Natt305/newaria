...
async def enhance_image_prompt(
    ...
    image_note = (
        ...
        "ART STYLE — analyze the rendering style you see in the reference photos and reproduce it. "
        "Do NOT default to a generic phrase. Describe the specific rendering type, line art, "
        "shading style, and color palette you observe in the photos.\n"
        if has_images else ""
    )

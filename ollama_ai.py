...
async def enhance_image_prompt(
    ...
    system = (
        ...
        "never collapse into a single name like 'amber' or 'hazel':\n"
        "  * HUE FAMILY: e.g. 'warm olive-brown', 'gray-green', 'khaki', 'dusty brown-olive'\n"
        "  * SATURATION: 'very low saturation', 'muted', 'desaturated', 'soft', or 'vivid'\n"
        "  * BRIGHTNESS/CONTRAST: 'medium brightness', 'slightly dark', 'light'\n"
        "  Example: 'very low-saturation warm olive-brown eyes, muted and soft, medium brightness'\n"
        "  NOT: 'amber eyes' — too vague, forces model to render vivid warm amber\n"
        "- EYELASHES (three-axis required): describe lash appearance using ALL THREE axes:\n"
        "  * HUE: e.g. 'warm gray-brown', 'pale brown', 'warm beige'\n"
        "  * DARKNESS/CONTRAST: 'very low contrast against skin', 'soft', 'not dark'\n"
        "  * WEIGHT: 'fine and light', 'delicate', 'subtle'\n"

    ...
    if scene_only:
        ...
        if prose_context and prose_context.strip():
            _prose_block_so = (
                ...
                "MANDATORY: your output MUST begin by naming the LOCATION / SETTING "
                "of the scene — this is required even if the prose does not explicitly "
                "describe a change of location. Do not skip or defer the location. "
                "Then also embed: (2) time of day, (3) weather or lighting conditions, "
        ...
        system_so = (
            ...
            f"{_prose_block_so}"
            "LOCATION TAG RULE: if the image request begins with a "
            "`[Location: ...]` tag, you MUST reproduce that location as the "
            "background setting of your output — do not substitute a different "
            "setting. The tag is an operator-supplied anchor and overrides any "
            "location you might infer from the rest of the request.\n"

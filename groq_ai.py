...
async def enhance_image_prompt(
    ...
    system = (
        ...
        "'honey eyes' — these fail because Flux ignores saturation. Always pair hue with explicit saturation level. "
        ...
        "Must appear as a SEPARATE lower-body entry, NOT hidden by the jabot. "
        "Describe as: 'deep-crimson shorts; double-row gold buttons, visible below waist, mid-thigh length'.\n"

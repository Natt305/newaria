...
async def enhance_image_prompt(
    ...
    if has_images:
        image_note = (
            ...
            "ART STYLE — analyze and reproduce the rendering style you see in the reference photos. "
            "The generated image must match the reference's visual style. "
            "Do NOT default to a generic 'anime art style' phrase — describe the specific style you observe.\n"
    ...
    system = (
        ...
        "  * RENDERING TYPE: e.g. 'clean cell-shaded anime', 'soft painterly digital illustration', "
        "'rough sketch-style line art', 'polished semi-realistic anime', 'flat graphic anime'\n"

...
async def enhance_image_prompt(
    ...
    system = (
        ...
        "When NO reference images are provided, default to: "
        "'2D anime illustration, flat cel-shaded, sharp black outlines, soft gradient shading, vivid saturated color palette, no photorealism, no 3D render, no CGI'.\n"
        "The output must always be 2D anime — never semi-realistic, never 3D CGI, never photorealistic.\n"

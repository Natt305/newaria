...
async def enhance_image_prompt(
    ...
    if has_images:
        image_note = (
            ...
            "The photos are the final word for these.\n"
            "EYE COLOR — use ONLY the text description above. Do NOT name eye color from "
            "the photos. Vision models systematically misread subtle or muted eye colors "
            "(e.g. soft olive-hazel) as vivid amber or honey. Trust the text.\n"
